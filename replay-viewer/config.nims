...
switch(
  "passL",
  (&"""
  -o {distDir / "garble_replay.js"}
  -O2
  -s ALLOW_MEMORY_GROWTH
  -s ABORTING_MALLOC=1
  -s ENVIRONMENT=web
  -s MODULARIZE=1
  -s EXPORT_NAME=GarbleReplayModule
  -s EXPORTED_RUNTIME_METHODS=HEAPU8
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_gar_load_replay,_gar_payload_ptr,_gar_payload_len,_gar_error_ptr,_gar_error_len
  """).replace("\n", " ")
)
